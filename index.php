	     ...
	     <div class="row_1">             
	     	...
	     	<div class="col-lg-8 col-sm-8">            
	     	    <div class="blog-entry-title">                     
	     	  	   <h4><a href="news_single.php">Read more</a></h4>                        
	     	  	   <h3><a href="news_single.php">voluptas sit aspernatur</a></h3>          
          ...
          <div class="row_1">             
	     	...
	     	<div class="col-lg-8 col-sm-8">            
	     	    <div class="blog-entry-title">                     
	     	  	   <h4><a href="news_single.php">Read more</a></h4>                        
	     	  	   <h3><a href="news_single.php">At vero eos et accusamus</a></h3>          
	     	  	      <div class="post-element clearfix">                         
	     	  	        <div class="post__1" style="overflow: hidden;">
	        	          <span class="post__1-item post__1-date">14.12.2015</span>
	        	          <span class="post__1-item"><span class="link_2"><a href="#" title="like me" class="like_button">
	     	...
	     	<div class="col-lg-4 col-sm-4">                 
	     		<div class="index-post-media">                     
	     			<div class="media-materials clearfix">                        
	     			   <img alt="" class="img-responsive" src="images/c14.jpg"/>                     
	     			</div>                 
	     	    </div>           
	     	</div>       
	     	<div class="col-lg-8 col-sm-8">            
	     	    <div class="blog-entry-title">                     
	     	  	   <h4><a href="news_single.php">Read more</a></h4>                        
	     	  	   <h3><a href="news_single.php">On the other hand, we denounce</a></h3>          
	     	  	      <div class="post-element clearfix">                         
	     	  	        <div class="post__1" style="overflow: hidden;">
	        	          <span class="post__1-item post__1-date">14.12.2015</span>
	        	          <span class="post__1-item"><span class="link_2"><a href="#" title="like me" class="like_button">
	     	...
	     	<div class="col-lg-4 col-sm-4">                 
	     		<div class="index-post-media">                     
	     			<div class="media-materials clearfix">                        
	     			   <img alt="" class="img-responsive" src="images/c13.jpg"/>                  
	     			</div>                 
	     	    </div>           
	     	</div>       
	     	<div class="col-lg-8 col-sm-8">            
	     	    <div class="blog-entry-title">                     
	     	  	   <h4><a href="news_single.php">Read more</a></h4>                        
	     	  	   <h3><a href="news_single.php">Lorem Ipsum as their</a></h3>          
	     	  	      <div class="post-element clearfix">                         
	     	  	        <div class="post__1" style="overflow: hidden;">
	        	          <span class="post__1-item post__1-date">14.12.2015</span>
	        	          <span class="post__1-item"><span class="link_2"><a href="#" title="like me" class="like_button">
